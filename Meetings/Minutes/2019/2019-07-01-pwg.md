...
**Avneesh Singh:** Regarding the 2nd question.  Epub 3 will gain a lot of traction after this move.  One thing I should say is that we should not release the standard version as the epub version.  And make the plans for the next big version.  We shouldn't do minor versions...  
...
**Avneesh Singh:** why a publisher from the IDPF world would pay soo much more.  There must be a compelling reason.  We need to reach out.  Many people from the publishing world were not in the WG.  We need to involve the epub3 CG.  Take a breath and do big outreach.  
… My question is - everyone in the W3C is good at pointing out the principles, but will they come and do the work to drive it forward.  Whatever we do, it has to be complete.  That is the next step - to justify the jump in membership fee  
