...
**Laurent Le Meur:** The other [issue](https://github.com/w3c/lpf/issues/) I haven't created a PR yet. It's only that we still make reference to the web pub manifest, and I have to redirect the reference to the publication - so it's an editorial.  
